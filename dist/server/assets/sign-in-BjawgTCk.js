...
import { b as Route, B as Button, a as authClient } from "./router-C0Ba-j9F.js";
...
function RouteComponent() {
  ...
  return /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto flex min-h-[calc(100vh-3.5rem)] items-center justify-center px-6 py-12", children: /* @__PURE__ */ jsxDEV("div", { className: "w-full max-w-sm space-y-6", children: [
    /* @__PURE__ */ jsxDEV("div", { className: "text-center space-y-2", children: [
      /* @__PURE__ */ jsxDEV("h1", { className: "text-2xl font-semibold tracking-tight", children: "Sign in to your account" }, void 0, false, {
        fileName: "/Users/webdevcody/Workspace/AgentSystemLabs/launch-kit/src/routes/sign-in.tsx?tsr-split=component",
        lineNumber: 64,
        columnNumber: 11
      }, this),
      /* @__PURE__ */ jsxDEV("p", { className: "text-sm text-muted-foreground", children: "Enter your email below to sign in" }, void 0, false, {
        fileName: "/Users/webdevcody/Workspace/AgentSystemLabs/launch-kit/src/routes/sign-in.tsx?tsr-split=component",
        lineNumber: 67,
        columnNumber: 11
      }, this)
      ...
      /* @__PURE__ */ jsxDEV(Form, { ...form, children: /* @__PURE__ */ jsxDEV("form", { onSubmit: form.handleSubmit(onSubmit), className: "grid gap-4", children: [
        ...
        /* @__PURE__ */ jsxDEV(FormField, { control: form.control, name: "password", render: ({
          ...
          /* @__PURE__ */ jsxDEV(FormControl, { children: /* @__PURE__ */ jsxDEV("div", { className: "relative", children: [
            /* @__PURE__ */ jsxDEV(Input, { placeholder: "Enter your password", type: showPassword ? "text" : "password", autoComplete: "current-password", disabled: isLoading, className: "pr-10", ...field }, void 0, false, {
              fileName: "/Users/webdevcody/Workspace/AgentSystemLabs/launch-kit/src/routes/sign-in.tsx?tsr-split=component",
              lineNumber: 111,
              columnNumber: 25
            }, this),
        ...
        /* @__PURE__ */ jsxDEV(Button, { disabled: isLoading, type: "submit", className: "w-full", children: isLoading ? "Signing in..." : "Sign In" }, void 0, false, {
          fileName: "/Users/webdevcody/Workspace/AgentSystemLabs/launch-kit/src/routes/sign-in.tsx?tsr-split=component",
          lineNumber: 119,
          columnNumber: 15
        }, this)
    ...
    /* @__PURE__ */ jsxDEV("p", { className: "text-center text-sm text-muted-foreground", children: /* @__PURE__ */ jsxDEV(Link, { to: "/sign-up", search: {
      redirect: void 0
    }, className: "underline underline-offset-4 hover:text-primary", children: "Don't have an account? Sign up" }, void 0, false, {
      fileName: "/Users/webdevcody/Workspace/AgentSystemLabs/launch-kit/src/routes/sign-in.tsx?tsr-split=component",
      lineNumber: 127,
      columnNumber: 11
    }, this) }, void 0, false, {
