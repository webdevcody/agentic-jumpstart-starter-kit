      ...
      {files.length > 0 && (
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <h4 className="text-sm font-medium text-green-700 dark:text-green-400">Selected Files</h4>
          </div>
          {files.map((file, index) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium truncate text-green-800 dark:text-green-200">{file.name}</p>
